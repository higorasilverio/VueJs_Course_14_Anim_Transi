...
<script>
import AlertaAdvertencia from "@/plugins/AlertaAdvertencia"
import AlertaInfo from "@/plugins/AlertaInfo"

export default {
	components: { AlertaAdvertencia, AlertaInfo },
	data(){
		return {
			alunos: ['Roberta', 'Hulia', 'Tereza', 'Paulo'],
			msg: 'Uma mensagem de info para user',
			exibir: false,
			exibir2: true,
			tipoAnimacao: 'fade',
			larguraBase: 0,
...
Classes comentadas pois são configurações padrões
*/
